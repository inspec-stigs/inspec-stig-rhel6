...
title 'V-38561 - The audit system must be configured to audit all discretionary access control permission modifications using lsetxattr.'
...
'
  tag 'stig','V-38561'
  tag severity: 'low'
  tag checkid: 'C-46119r2_chk'
  tag fixid: 'F-43509r2_fix'
  tag version: 'RHEL-06-000194'
  tag ruleid: 'SV-50362r3_rule'
  tag fixtext: '
...
# START_DESCRIBE
  describe auditd_rules.syscall('lsetxattr').action do
    it { should eq(['always']) }
  end
# END_DESCRIBE
