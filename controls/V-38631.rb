...
title 'V-38631 - The operating system must employ automated mechanisms to facilitate the monitoring and control of remote access methods.'
...
'
  tag 'stig','V-38631'
  tag severity: 'medium'
  tag checkid: 'C-46190r1_chk'
  tag fixid: 'F-43580r2_fix'
  tag version: 'RHEL-06-000148'
  tag ruleid: 'SV-50432r2_rule'
  tag fixtext: '
