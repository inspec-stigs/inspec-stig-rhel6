...
title 'V-38525 - The audit system must be configured to audit all attempts to alter system time through stime.'
...
'
  tag 'stig','V-38525'
  tag severity: 'low'
  tag checkid: 'C-46083r3_chk'
  tag fixid: 'F-43473r4_fix'
