...
title 'V-38563 - The audit system must be configured to audit all discretionary access control permission modifications using removexattr.'
...
'
  tag 'stig','V-38563'
  tag severity: 'low'
  tag checkid: 'C-46121r2_chk'
  tag fixid: 'F-43511r2_fix'
  tag version: 'RHEL-06-000195'
  tag ruleid: 'SV-50364r3_rule'
  tag fixtext: '
