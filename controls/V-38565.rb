...
title 'V-38565 - The audit system must be configured to audit all discretionary access control permission modifications using setxattr.'
...
'
  tag 'stig','V-38565'
  tag severity: 'low'
  tag checkid: 'C-46123r2_chk'
  tag fixid: 'F-43513r2_fix'
  tag version: 'RHEL-06-000196'
  tag ruleid: 'SV-50366r3_rule'
  tag fixtext: '
...
# START_DESCRIBE
  describe auditd_rules.syscall('setxattr').action do
    it { should eq(['always']) }
  end
# END_DESCRIBE
