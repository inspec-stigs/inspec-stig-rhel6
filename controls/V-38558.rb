...
title 'V-38558 - The audit system must be configured to audit all discretionary access control permission modifications using lchown.'
...
'
  tag 'stig','V-38558'
  tag severity: 'low'
  tag checkid: 'C-46116r2_chk'
  tag fixid: 'F-43506r2_fix'
  tag version: 'RHEL-06-000192'
  tag ruleid: 'SV-50359r3_rule'
  tag fixtext: '
