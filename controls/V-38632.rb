...
title 'V-38632 - The operating system must produce audit records containing sufficient information to establish what type of events occurred.'
...
'
  tag 'stig','V-38632'
  tag severity: 'medium'
  tag checkid: 'C-46191r1_chk'
  tag fixid: 'F-43581r2_fix'
  tag version: 'RHEL-06-000154'
  tag ruleid: 'SV-50433r2_rule'
  tag fixtext: '
