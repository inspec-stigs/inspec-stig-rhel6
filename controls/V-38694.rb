...
title 'V-38694 - The operating system must manage information system identifiers for users and devices by disabling the user identifier after an organization defined time period of inactivity.'
...
'
  tag 'stig','V-38694'
  tag severity: 'low'
  tag checkid: 'C-46256r1_chk'
  tag fixid: 'F-43643r2_fix'
  tag version: 'RHEL-06-000335'
  tag ruleid: 'SV-50495r1_rule'
  tag fixtext: '
