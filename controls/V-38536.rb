...
title 'V-38536 - The operating system must automatically audit account disabling actions.'
...
'
  tag 'stig','V-38536'
  tag severity: 'low'
  tag checkid: 'C-46094r1_chk'
  tag fixid: 'F-43484r1_fix'
  tag version: 'RHEL-06-000176'
  tag ruleid: 'SV-50337r1_rule'
  tag fixtext: '
